...
public class MemberDAO {
	...
	private Member restToMember(ResultSet rset) throws SQLException {
	...
	public int updateMember(Connection conn, Member member) {
		String query = "UPDATE MEMBER_TBL SET MEMBER_PW = ?, MEMBER_GENDER = ?,MEMBER_EMAIL = ?, MEMBER_EMAIL = ?, MEMBER_ADDRESS = ?, MEMBER_HOBBY = ?, UPDATE_DATE = DEFAULT WHERE MEMBER_ID = ?";
		PreparedStatement pstmt = null;
		int result = 0;
